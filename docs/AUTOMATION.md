...
| `edition` (v6) | the same sitting | the run notes the article's word count before and after; growth over a quarter needs a reason in the rationale |
