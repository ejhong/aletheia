...
const packet = [
  ...
  omitted.length > 0
    ? `=== OMITTED FILES (diff over size budget — you have NOT seen these in the DIFF; a file marked as read into the RUN ACCOUNT is shown there, as its section says) ===\n${omittedNotes(omitted, account.files).join("\n")}`
