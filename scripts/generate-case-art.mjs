 ...
 * a human picks the winner during PR review. Retired in the subtraction of
 * 2026-09-09 and returned the same day on the founder's direction
 * (docs/DECISIONS.md); the loop makes no images, an edition seats the
 * plates that exist.
 */
...
const CASE_SUBJECTS = {
  ...
  "deep-memory":
    "Two carved stone figures set far apart on a long empty shore, facing " +
    "each other across the water: a bird-headed figure in profile with a " +
    "bent limb and a small disc held near it on one side, a broad-shouldered " +
    "statue with hands meeting on its belly on the other, and between them, " +
    "half-buried in the sand, a single handled stone object. Their outlines " +
    "rhyme; nothing joins them but the horizon. An allegorical emblem of " +
    "resemblance across distance — never a depiction of any real monument, " +
    "site, or excavated object as documentation.",
  "pre-columbian-amazon":
