 ...
 * tariffs, budget, founder. One reader: the file must satisfy its schema,
 * and unless the caller supplies what a missing file means, it must exist
 * — configuration is never defaulted into existence silently.
 */
